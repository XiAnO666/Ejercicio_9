...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkboxM07 = findViewById(R.id.checkBox) as CheckBox
        ...
        val checkboxM15 = findViewById(R.id.checkBox2) as CheckBox
        ...
        val checkboxM08 = findViewById(R.id.checkBox3) as CheckBox
